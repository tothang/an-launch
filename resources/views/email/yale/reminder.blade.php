...
@section('title', __('email.reminder.yale.title', [], $locale))

@section('description', __('email.reminder.yale.description', [], $locale))
        ...
        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
            <tr style="vertical-align:top;">
                ...
                <td background="{{ asset('/img/yale/email/yale-save-the-date-hero.jpg') }}"
                    style="background: #fffffd url('{{ asset('/img/yale/email/yale-save-the-date-hero.jpg') }}') no-repeat center center / cover; background-position: center center; background-repeat: no-repeat; padding: 189px 0 50px 0; vertical-align: top; background-size: 600px 475px;"
                    valign="top">
                    <!--[if mso | IE]>
                    ...
                    <div class="mj-hero-content" style="margin:0px auto;width:100%;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;margin:0px;">
                                        <tr>
                                            <td align="left" class="dark-hero-text-large fallback-hero-large"
                                                ...
                                                <?php
                                                $fontSize = '96px';
                                                if (in_array($locale, ['ru', 'cs','pl'])) $fontSize = '40px';
                                                if (in_array($locale, ['de'])) $fontSize = '80px';
                                                ?>
                        ...
                        <span class="dark-hero-text-large fallback-hero-large"
                          ...
                          {!! __('email.reminder.yale.header_text', [], $locale) !!}
                        </span>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td align="left" class="dark-hero-text-small"
                                                style="font-size:0px;padding:20px 25px 0 50px;word-break:break-word;">
                                                <div style="font-family: 'DINNextLTPro-Regular', Arial, sans-serif;font-size:26px;line-height:26px;text-align:left;color:#3e4545;">
                        <span class="dark-hero-text-small" style="color:#3e4545!important;font-size:26px;line-height:26px;">
                          {!! __('email.reminder.yale.event_date', [], $locale) !!}
                        </span>
                                                </div>
                                            </td>
                                        </tr>
                    ...
                    <div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            ...
                            <tr>
                              ...
                              {{ __('email.reminder.yale.dear', [], $locale) }},
                              </span>
                                                    </p>
                                                </div>
                                            </td>
                                            ...
                                            <td align="left" style="font-size:0px;padding:0;word-break:break-word;">
                                                <div style="font-family: 'DINNextLTPro-Regular', Arial, sans-serif;font-size:14px;line-height:23px;text-align:left;color:#3e4545;">
                                                    <p style="margin-top: 25px; margin-bottom: 25px;">
                                                        {!! __('email.reminder.yale.content', [], $locale) !!}
                                                    </p>
                                                </div>
                                            </td>
                                        </tr>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    ...
                                                    <tr>
                                                        <td align="center" bgcolor="#e5a713" role="presentation"
                                                            ...
                                                            valign="middle">
                                                            <a href="{{ $url }}"
                                                               style="background:#e5a713;color:#000000;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:600;line-height:120%;Margin:0;text-decoration:none;text-transform:none;"
                                                               target="_blank">
                                                                <strong>{!! __('email.reminder.yale.register_online_text', [], $locale) !!}</strong>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                </table>
                                        ...
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:0;word-break:break-word;">
                                                <div style="font-family: 'DINNextLTPro-Regular', Arial, sans-serif;font-size:14px;line-height:23px;text-align:left;color:#3e4545;">
                                                    <p style="margin-top: 25px; margin-bottom: 25px;">{!! __('email.reminder.yale.content_2', [], $locale) !!} <a class="link" style="font-weight:bold; color: #3e4545!important; text-decoration: none;" href="{{ 'mailto:' . config('services.email_contact.yale') }}"><font color="#3e4545"><strong>{{ config('services.email_contact.yale') }}.</strong></font></a></p>
                                                    <p style="margin-top: 25px; margin-bottom: 25px;">{!! __('email.reminder.yale.thank', [], $locale) !!}</p>
                                                    <p style="margin-top: 25px; margin-bottom: 25px;">
                                                        <strong><span style="font-weight:900">{{ __('email.reminder.yale.signature', [], $locale) }}</span></strong></p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
